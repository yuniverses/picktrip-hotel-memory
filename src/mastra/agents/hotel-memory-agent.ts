...
export const hotelMemoryAgentInstructions = [
  ...
  "Call recallPreferences on every request about hotels, recommendations, or prior choices.",
  "Call personalizeHotelMap only when the user requests a search, recommendation, map update, or states a preference that should change the current recommendations.",
  "For follow-up questions such as why, compare, explain, or clarify, answer naturally from prior turns, recalled preferences, and tool-grounded hotel names; do not repeat a pin-update summary or call personalizeHotelMap unless the user also asks to change the map.",
  ...
  "When personalizeHotelMap returns upsert operations on a map-changing turn, state in English that the pins were added to the current destination map.",
